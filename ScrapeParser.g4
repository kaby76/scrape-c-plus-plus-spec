...
shift_expression : (  additive_expression ) ( LeftShift additive_expression | RightShift additive_expression ) * ;
...
noptr_abstract_declarator : ( LeftParen ptr_abstract_declarator RightParen | parameters_and_qualifiers | LeftBracket constant_expression ? RightBracket attribute_specifier_seq ? ) ( parameters_and_qualifiers | LeftBracket constant_expression ? RightBracket attribute_specifier_seq ? ) * ;
