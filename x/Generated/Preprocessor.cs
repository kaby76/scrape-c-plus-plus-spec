...
namespace Test
{
    public class Preprocessor : CPlusPlus14ParserBaseVisitor<IParseTree>
    {
        ...
        public override IParseTree VisitPreprocessing_token([NotNull] CPlusPlus14Parser.Preprocessing_tokenContext context)
        {
            base.VisitPreprocessing_token(context);
            return null;
        }

        public override IParseTree VisitPreprocessing_op_or_punc([NotNull] CPlusPlus14Parser.Preprocessing_op_or_puncContext context)
        {
            throw new NotImplementedException();
        }

        public override IParseTree VisitBoolean_literal([NotNull] CPlusPlus14Parser.Boolean_literalContext context)
        {
            throw new NotImplementedException();
        }

        public override IParseTree VisitPointer_literal([NotNull] CPlusPlus14Parser.Pointer_literalContext context)
        {
            throw new NotImplementedException();
        }
        ...
        public override IParseTree VisitPreprocessing_file([NotNull] CPlusPlus14Parser.Preprocessing_fileContext context)
        {
        ...
        public override IParseTree VisitGroup([NotNull] CPlusPlus14Parser.GroupContext context)
        {
            ...
            for (int c = 0; c < context.ChildCount;)
            {
                ...
                if (child is CPlusPlus14Parser.Text_lineContext)
                {
                    int count = 1;
                    var start = c;
                    var end = c + 1;
                    for (c++; c < context.ChildCount; ++c)
                    {
                        ...
                        if (!(context.GetChild(c).GetChild(0) is CPlusPlus14Parser.Text_lineContext))
                        {
                            break;
                        }
                        count++;
                    ...
                    var toks = context.children
                        ...
                        .SelectMany(ch =>
                        {
                            var text = ch.GetChild(0) as CPlusPlus14Parser.Text_lineContext;
                            if (text == null) return new CPlusPlus14Parser.Preprocessing_tokenContext[0];
                            else if (text.pp_tokens() == null) return new CPlusPlus14Parser.Preprocessing_tokenContext[0];
        ...
        public override IParseTree VisitElif_groups([NotNull] CPlusPlus14Parser.Elif_groupsContext context)
        {
        ...
        public override IParseTree VisitElif_group([NotNull] CPlusPlus14Parser.Elif_groupContext context)
        {
        ...
        public override IParseTree VisitElse_group([NotNull] CPlusPlus14Parser.Else_groupContext context)
        {
            // Get state from ancestor if_section. Do not visit if true.
            var if_section = context.Parent as CPlusPlus14Parser.If_sectionContext;
        ...
        public override IParseTree VisitEndif_line([NotNull] CPlusPlus14Parser.Endif_lineContext context)
        {
        ...
        public override IParseTree VisitNon_directive([NotNull] CPlusPlus14Parser.Non_directiveContext context)
        {
            throw new NotImplementedException();
        }

        public override IParseTree VisitLparen([NotNull] CPlusPlus14Parser.LparenContext context)
        {
            throw new NotImplementedException();
        }

        public override IParseTree VisitIdentifier_list([NotNull] CPlusPlus14Parser.Identifier_listContext context)
        {
            throw new NotImplementedException();
        }

        public override IParseTree VisitReplacement_list([NotNull] CPlusPlus14Parser.Replacement_listContext context)
        {
            throw new NotImplementedException();
        }

        public override IParseTree VisitPp_tokens([NotNull] CPlusPlus14Parser.Pp_tokensContext context)
        {
            base.VisitPp_tokens(context);
            return null;
        }

        public override IParseTree VisitNew_line([NotNull] CPlusPlus14Parser.New_lineContext context)
        {
        ...
        public override IParseTree VisitText_line([NotNull] CPlusPlus14Parser.Text_lineContext context)
        {
