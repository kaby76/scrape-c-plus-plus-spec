// Modified by KED for testing.
#ifndef _SYS__INTSUP_H
#define _SYS__INTSUP_H

// KED -- configure for testing.
#define __STDINT_EXP(x) __##x##__
#define __INTPTR_TYPE__ 8
#define __INT8_TYPE__ 1
#define __INT16_TYPE__ 2
#define __INT32_TYPE__ 4
#define __INT64_TYPE__ 8
#define __INT_FAST8_TYPE__ 4
#define __INT_FAST16_TYPE__ 4
#define __INT_FAST32_TYPE__ 4
#define __INT_FAST64_TYPE__ 8
#define __INT_LEAST8_TYPE__ 1
#define __INT_LEAST16_TYPE__ 2
#define __INT_LEAST32_TYPE__ 4
#define __INT_LEAST64_TYPE__ 8
